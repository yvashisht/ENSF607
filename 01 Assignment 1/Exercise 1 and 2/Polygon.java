...
class Polygon {
	...
	public static int classID(){
        ...
        public String toString() {
        	...
        	StringBuilder sb = new StringBuilder("The lines in polygon " + objID + " are: \n");
        	int lineCount = 1;
        	
        	for (Line line : polygon) {
                sb.append("Line ").append(lineCount).append(": starts at ")
                .append(line.start).append(", and ends at ")
                .append(line.end).append("\n");
              lineCount++;
        	}
